            ...
            if(mysqli_num_rows($res)>0){
                while($row = mysqli_fetch_assoc($res)){
                    ...
                    <tr>
                        ...
                        <td><?php echo $date ?></td>
                        <td><?php echo $phno ?></td>
                        <td><a class='btn text-light ' style='background-color: #20c997;' href="<?php echo SIZEURL;?>src/edit.php?id=<?php echo $row['reci_id'];?>"><i class="far fa-edit"></i></a></td>
                        <td><a class='btn text-light ' style='background-color: #20c997;' href="<?php echo SIZEURL;?>arc/delete.php?id=<?php echo $row['reci_id'];?>"><i class="fas fa-trash-alt"></i></a></td>
                    </tr>
                    <?php
                }
            }
